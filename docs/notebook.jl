...
# ╔═╡ 94ec80e6-cd6d-4b23-bd95-895a62c37d5a
begin
    using JSServe
    JSServe.Page()
end

# ╔═╡ d365f302-c038-4de6-b16a-04f7fc9dc0b3
begin
	using Colors
	using JSServe: rows, onjs

	App() do session::Session

		slider1 = Slider(0:360)
...
# ╔═╡ e2fc909d-b5fb-46a2-a502-632073fb7641
begin
	using Markdown
	using WGLMakie
...
# ╔═╡ 0cd16425-4f1a-4a74-96fb-3a89753a6889
using PyCall

# ╔═╡ 43aa6357-7c09-43c0-8a6a-d250608f6c88
begin
	WGLMakie.activate!()
