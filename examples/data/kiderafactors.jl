rezdict = jldopen("rezdict.jld2","r") do file
    file["rezdict"]
end
kiderafactors3 = vcat(vcat(readdlm("kiderafactors.csv", ','),_t([".",[nothing for i = 1:10]...])),_t(["-",[nothing for i = 1:10]...]),_t(["*",[nothing for i = 1:10]...]))
