...
Get the inspector label function for plotting a structure.
"""
...
"""
    inspectorlabel( struc::Observable{T} )
...
Show an example of the inspector label function looks like.
"""
...
"""
    atomcolors( inspectorfunc::Function )
